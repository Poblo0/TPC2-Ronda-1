class Bot:
    ...
    def get_pickup_x(self):
        if (self.have_bomb() or self.enemy_has_bomb()):
            return None
        else:
            return self.__bomb_pos[0]
    ...
    def read_map(self, file_path):
        with open(file_path, 'r') as file:
            ...
            self.__bomb_pos = self.get_initial_pos(self.__map, 'B')
    ...
    def get_initial_pos(self, matrix, character):
